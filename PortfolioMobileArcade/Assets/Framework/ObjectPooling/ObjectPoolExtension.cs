...
public static class ObjectPoolExtension
{
    ...
    public static T SpawnFromPool<T>(this T component,  Vector3 position = new Vector3(), Quaternion rotation = new Quaternion()) where T : Component
    {
        return ObjectPool.Instance.Spawn(component, position,rotation);
    }
    ...
    public static GameObject SpawnFromPool(this GameObject gameObject, Vector3 position = new Vector3(), Quaternion rotation = new Quaternion())
    {
        return ObjectPool.Instance.Spawn(gameObject.transform,position,rotation).gameObject;
    }
}   